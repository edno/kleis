...
<head>
    ...
    <script src="/js/random.js" type="text/javascript" language="javascript"></script>
    <script src="/js/string.js" type="text/javascript" language="javascript"></script>
    <script src="/js/kleis.js" type="text/javascript" language="javascript"></script>
    <script src="/js/copyclipboard.js" type="text/javascript" language="javascript"></script>
